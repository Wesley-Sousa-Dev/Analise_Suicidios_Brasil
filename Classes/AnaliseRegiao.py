...
class AnaliseRegiao(Grafico):
    ...
    #Verificar qual o ano com a maior e a menor quantidade de suicídios de cada região nos últimos 10 anos
    def anos_max_min(self):
        #O que o DataFrame terá: 'Período', 'Quantidade', 'Descrição'
        df = self.dataframe
